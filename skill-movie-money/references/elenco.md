...
- **Idade:** 27 | **Imagem-base:** `templates/personagens/lucas_ferreira.png`
- **Visual:** Brasileiro, pele morena clara, cabelo castanho escuro curto texturizado, barba rala aparada, camiseta lisa cinza, corrente fina prateada. "Cara normal gente boa".
- **Personalidade:** O amigo que descobre as coisas primeiro. Curioso, prático, direto. Fala como áudio pro melhor amigo.
...
- **Idade:** 24 | **Imagem-base:** `templates/personagens/marina_costa.png`
- **Visual:** Brasileira, pele parda, cabelo cacheado volumoso castanho com reflexos mel, maquiagem leve, brincos dourados pequenos, blusa bege neutra. "Menina real do Instagram".
- **Personalidade:** A amiga de skincare/cabelo/rotina. Detalhista, honesta, estilo "review sincero" — fala o que não gostou antes de revelar o que amou.
...
- **Idade:** 32 | **Imagem-base:** `templates/personagens/rafael_santos.png`
- **Visual:** Homem negro, porte atlético natural, cabeça raspada, barba média bem desenhada, henley escura, relógio discreto. "Homem com a vida organizada".
- **Personalidade:** Pesquisa antes de comprar. Analítico, calmo, autoridade natural. Análise objetiva + toque pessoal no final.
...
- **Idade:** 29 | **Imagem-base:** `templates/personagens/beatriz_oliveira.png`
- **Visual:** Mulher branca, cabelo liso loiro escuro nos ombros, olhos verde-mel, maquiagem natural com batom nude, blazer claro. Jovem profissional criativa/digital.
- **Personalidade:** Prática, resolve. Energia de "testei dez opções e essa funciona". Curadoria e leve perfeccionismo que gera confiança.
...
- **Idade:** 22 | **Imagem-base:** `templates/personagens/diego_almeida.png`
- **Visual:** Jovem, pele clara, cabelo castanho médio com franja bagunçada, moletom oversized, fone no pescoço. Gen Z criador de conteúdo.
- **Personalidade:** Caçula do elenco, autenticidade crua. Grava como story sem roteiro. "Unboxing emocional" — a reação vende. Menos técnico, mais emocional.
...
1. **Seleção por produto:** escolher 1–2 personagens pelo nicho e público-alvo. Nunca escalar fora do perfil.
2. **Consistência:** todo novo asset visual do personagem DEVE usar a imagem-base como `references` na geração.
3. **Rotação A/B:** múltiplos criativos do mesmo produto = personagens diferentes; o vencedor recebe as variações de hook.
4. **Estrutura de roteiro:** Hook (0–4s, usar hook-assinatura ou variação) → Problema → Causa → Solução (produto) → CTA forte.
