...
| Campo | Valor |
|---|---|
| Arquivo | `/home/ubuntu/Moviemoney/auditoria_video/masters/sunscreen_gc_v6.mp4` |
| SHA-256 | `db887dee3ef98e2aad27433ead6d25416ef7017d113a2344e1152ac542eb3ec1` |
| Perfil | `short` |
| Duração | 40.500 s |
...
| drift_duracao | **PASS** | 0.007 s | <= 0.050 s |
| delta_inicio | **PASS** | 0.000 s | <= 0.020 s |
| cauda_silenciosa | **PASS** | 0.007 s | <= 0.200 s |
